...
public class Util {
    ...
    public static String SHARED_PREF_KEY_AUDIO_PLAYER_CURRENT_PLAYING_AUDIO =  "SHARED_PREF_KEY_AUDIO_PLAYER_CURRENT_PLAYING_AUDIO";
    ...
    // IMAGE ARTICLE
    public static String SHARED_PREF_KEY_ARTICLE_ID=  "SHARED_PREF_KEY_ARTICLE_ID";
    ...
    public static String SHARED_PREF_KEY_TODAY_INFO_BANNER_IMG2_URL = "SHARED_PREF_KEY_TODAY_BANNER_IMG2_URL";
    public static String SHARED_PREF_KEY_TODAY_INFO_BANNER_IMG3_URL = "SHARED_PREF_KEY_TODAY_BANNER_IMG3_URL";
    ...
    public static String SHARED_PREF_KEY_TODAY_AUDIO2_TRACK_ID = "SHARED_PREF_KEY_TODAY_AUDIO2_TRACK_ID";
    public static String SHARED_PREF_KEY_TODAY_AUDIO2_URL = "SHARED_PREF_KEY_TODAY_AUDIO2_URL";
    public static String SHARED_PREF_KEY_TODAY_AUDIO2_IMG_URL = "SHARED_PREF_KEY_TODAY_AUDIO2_IMG_URL";
    public static String SHARED_PREF_KEY_TODAY_AUDIO2_TITLE = "SHARED_PREF_KEY_TODAY_AUDIO2_TITLE";
    public static String SHARED_PREF_KEY_TODAY_AUDIO2_BODY = "SHARED_PREF_KEY_TODAY_AUDIO2_BODY";
    public static String SHARED_PREF_KEY_TODAY_AUDIO2_UPLOAD_TIME = "SHARED_PREF_KEY_TODAY_AUDIO2_UPLOAD_TIME";
